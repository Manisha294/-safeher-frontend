  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex',
      ...
      <div style={{ width: '45%',
        ...
        <div style={{ width: 72, height: 72, background: 'rgba(255,255,255,0.15)',
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif",
          ...
          lineHeight: 1.1, marginBottom: 20, position: 'relative', zIndex: 1 }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center',
        ...
        <div style={{ width: '100%', maxWidth: 420, position: 'relative',
          zIndex: 1, animation: 'slideUp 0.6s cubic-bezier(0.16,1,0.3,1) both' }}>
          ...
          <div style={{ display: 'flex', background: '#ede8ec',
            ...
            {['signup', 'login'].map(t => (
              <button key={t} onClick={() => { setTab(t); setMsg({ text: '', color: '' }) }}
                style={{ flex: 1, padding: 10, border: 'none', borderRadius: 9,
          ...
          {tab === 'signup' ? (
            signupFields.map(f => (
              <div key={f.id} style={{ marginBottom: 22 }}>
                <label style={{ display: 'block', fontSize: '0.82rem',
                  fontWeight: 600, color: 'var(--charcoal)', marginBottom: 8,
            ...
            <>
              {[
                ...
                <div key={f.id} style={{ marginBottom: 22 }}>
                  ...
                  <input id={f.id} type={f.type} placeholder={f.placeholder}
                    ...
                    onChange={e => setLoginForm({ ...loginForm, [e.target.id]: e.target.value })}
                    style={inputStyle}
                    onFocus={e => e.target.style.borderColor = 'var(--rose)'}
                    onBlur={e => e.target.style.borderColor = '#e8e0e5'} />
                </div>
              ...
              <div style={{ textAlign: 'right', marginBottom: 20, marginTop: -8 }}>
                <Link to="/forgot-password" style={{ color: 'var(--rose)',
          ...
          {msg.text && (
            <p style={{ textAlign: 'center', marginTop: 16, fontWeight: 600,
              fontSize: '0.9rem', color: msg.color }}>{msg.text}</p>
          )}
        </div>
      </div>
    </div>
